import argparse
import os
from model_triangle import GIN

parser = argparse.ArgumentParser(
    description='Experiments on EMNIST with GIN (training script)')
parser.add_argument('--n_epochs', type=int, default=80,
                    help='Number of training epochs (default 100)')
# parser.add_argument('--n_epochs_2s', type=int, default=0,
#                     help='Number of training epochs (default 100)')
...
model = GIN(dataset='triangle',
            n_epochs=args.n_epochs,
            #     n_epochs_2s=args.n_epochs_2s,
